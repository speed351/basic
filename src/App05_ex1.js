    ...
    render(){
        return (
            <div className="container">
                ...
                <h3>모듈화된 css를 좀 더 편하게 사용하기</h3>
                <p className={styles["text-red"]}>p1 이다</p>
                <p className={cx('text-red', 'text-bold')}>p2 다</p>
                <p className={cx('text-yellow',{'text-bold':true})}>p3 이다</p>
            </div>
        );
    }
    onCheckChange=(e)=>{
